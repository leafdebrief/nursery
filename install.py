...
def install_nursery(home_dir="/home/pi"):
    ...
    print("Enabling Nursery database daemon")
    shell.copy(f"{home_dir}/nursery/scripts/daemons/nursery-db.service", "/lib/systemd/system/")
    shell.run_command(f"sudo cp {home_dir}/nursery/scripts/daemons/nursery-db.service /lib/systemd/system/")
    shell.run_command("sudo chmod 644 /lib/systemd/system/nursery-db.service")
    print("Enabling Nursery camera daemon")
    shell.copy(f"{home_dir}/nursery/scripts/daemons/nursery-cam.service", "/lib/systemd/system/")
    shell.run_command(f"sudo cp {home_dir}/nursery/scripts/daemons/nursery-cam.service /lib/systemd/system/")
    shell.run_command("sudo chmod 644 /lib/systemd/system/nursery-cam.service")
